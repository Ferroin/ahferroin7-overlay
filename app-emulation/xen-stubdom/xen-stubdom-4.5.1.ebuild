...
DESCRIPTION="Allows de-aggregation of various parts of Domain-0 for better isolation and performance."
HOMEPAGE="http://xen.org/"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="custom-cflags +ioemu vtpm xenstore"

DEPEND="sys-devel/gettext"

RDEPEND=">=app-emulation/xen-4.5.1"
...
src_configure() {
	econf \
		$(use_enable ioemu ioemu-stubdom) \
		$(use_enable vtpm vtpm-stubdom) \
		$(use_enable vtpm vtpmmgr-stubdom) \
		$(use_enable xenstore xenstore-stubdom) \
		--disable-c-stubdom --disable-caml-stubdom
}
